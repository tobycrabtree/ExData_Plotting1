...
## plots
par(mfrow=c(2,2))
plot(dataSubset$Day,dataSubset$Global_active_power, ylab="Global Active Power", lwd=1, type="l", xlab="")

plot(dataSubset$Day,dataSubset$Voltage, ylab="Voltage", lwd=1, type="l", xlab="datetime")
